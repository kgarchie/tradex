<template>
  <div class="contact max-w-[1200px]">
    <div class="container">
      <div class="glamour-box">
        ...
        <div class="body">
          <div class="phone">
            ...
            <p>{{ $config.public['contactCallNumber'] }}</p>
          </div>
          <div class="email">
            <div class="icon">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
            ...
            <a :href="`mailto:${$config.public['contactEmail']}`">{{ $config.public['contactEmail'] }}</a>
          </div>
          <div class="location">
            <div class="icon">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                   xmlns="http://www.w3.org/2000/svg">
                <path
                    d="M12 2C8.134 2 5 5.134 5 9C5 14.25 12 22 12 22C12 22 19 14.25 19 9C19 5.134 15.866 2 12 2ZM12 11C10.343 11 9 9.657 9 8C9 6.343 10.343 5 12 5C13.657 5 15 6.343 15 8C15 9.657 13.657 11 12 11Z"
                    fill="white"/>
              </svg>
            </div>
  ...
  <ClientOnly>
    <SVG name="blue_blob"
         v-for="i in 20"
         class="w-72 absolute -z-10 opacity-30 blur-lg"
         :key="i"
