...
<template>
  <div class="max-w-[1200px] m-auto text-white font-roboto isolate">
    ...
    <Banner class="z-10 bg-Brown backdrop-blur-3xl rounded-lg bg-opacity-80 banner shadow-lg"
            variant="secondary">
      ...
      <div class="flex gap-8 max-sm:flex-col">
        ...
        <div class="w-full max-sm:exempt-scroll max-sm:overflow-y-scroll max-sm:h-80">
          <p class="font-bold mb-1  max-sm:exempt-scroll">
          ...
          <p class="mb-1 max-sm:exempt-scroll">
            We offer global <span class="font-bold">logistics services</span> including but not limited to clearing and
          ...
          <p class="mb-1 max-sm:exempt-scroll">
            Based in <span class="font-bold">Mombasa, Kenya</span> next to East Africa’s biggest port, Kenya TradeX is
            placed strategically to provide
            all
